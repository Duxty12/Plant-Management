      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-7">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm">
            Manage your greenhouse sections and their
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 min-h-[300px] flex items-center justify-center">
              ...
              <div className="text-center">
                ...
                {sections.length === 0 && (
                  <button
                    onClick={openCreateModal}
                    className="mt-5 inline-flex items-center gap-2 px-4 py-2 bg-[#1B3B2C] hover:bg-[#14532d] text-white text-sm font-semibold rounded-lg transition"
                  >
                    <Plus className="w-4 h-4" />
                    Add Section
                  </button>
            ...
            >
              ...
              <div className="pt-2 border-t border-gray-100 flex gap-3">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="flex-1 py-2.5 bg-[#1B3B2C] hover:bg-[#14532d] text-white rounded-xl text-sm font-semibold transition shadow-sm disabled:opacity-60 flex items-center justify-center gap-2"
                >
