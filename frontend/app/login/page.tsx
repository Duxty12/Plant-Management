        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="px-8 pt-8 pb-10">
            ...
            <div className="flex flex-col items-center mb-8">
              ...
              <h1 className="text-2xl font-bold text-[#1B3B2C] tracking-tight">Exotic Botanicals</h1>
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <button type="button" className="text-xs text-green-700 hover:text-green-800 font-medium transition">
                    Forgot Password?
                  </button>
                </div>
                <div className="relative">
              ...
              <div className="flex items-center gap-2.5">
                <input
                  ...
                  className="w-4 h-4 rounded border-gray-300 text-green-600 focus:ring-green-400 accent-green-700"
                />
